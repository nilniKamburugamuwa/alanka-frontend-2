    ...
    <div className='home'>
        <div className='home__container'>
            ...
            <div className="home__row">
                ...
                <Product id={12355} title = 'Water Lip Stain - CLARINS - Smith & Caughey' price={39.99} image = 'https://www.smithandcaugheys.co.nz/data/media/images/catalogue/T314/199950_1.jpg?height=1500&width=1000&404=default.jpg' rating = {3} />
                <Product id={12345} title = 'Nestea Lemon Ice 350ml' price={9.99} image = 'https://cf.shopee.ph/file/625422a0a0d5d4ee88a8b8471f6743e8' rating = {5} />
            </div>

            <div className="home__row">
                <Product id={12345} title = 'Wholesale LOreal cosmetics' price={123.99} image = 'https://i.pinimg.com/originals/80/1e/25/801e250c39a9fb9d2a4c716a896a2d3f.jpg' rating = {5} />
            </div>
        </div>
    </div>
  )
